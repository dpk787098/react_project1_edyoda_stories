...
import CardComponent from './components/card_component/card_component';
...
function App() {
  const filterItems = [
    ...
    {name: "Programming Languages", selected: false},
    {name: "Mobile Application Developmant", selected: false},
    {name: "Technology and Tools", selected: false},
    {name: "Get a Job in a Tech Company", selected: false},
